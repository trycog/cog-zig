...
(`build.zig` and `src/main.zig` read the version from `cog-extension.json`)
...
- Add a link reference at the bottom: `[X.Y.Z]: https://github.com/trycog/cog-zig/releases/tag/vX.Y.Z`
